...
function ShowcaseCard({
  ...
  return (
    <article className="rounded-3xl border border-[#B8D8E8] bg-white/95 p-5 shadow-[0_14px_40px_-24px_rgba(20,60,80,0.35)]">
      <header className="mb-4">
        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#2E6F8F]">
          {title}
        </p>
...
export function LandingShowcase() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-24">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[#EAF4FA] to-transparent"
      />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 lg:grid-cols-3">
          ...
          >
            <div className="space-y-3">
              {[
                ...
                <div
                  key={step.label}
                  className="flex items-start gap-3 rounded-2xl border border-[#C8DDE8] bg-[#EAF4FA] p-3"
                >
                  <div className="rounded-xl bg-[#2E6F8F]/10 p-2 text-[#2E6F8F]">
          ...
          >
            <div className="rounded-2xl border border-[#C8DDE8] bg-[#EAF4FA] p-4">
              <div className="mb-3 flex items-center justify-between">
                <span className="rounded-full bg-[#2E6F8F]/10 px-3 py-1 text-xs font-semibold text-[#2E6F8F]">
                  Mittagessen
                </span>
          ...
          >
            <div className="space-y-3 rounded-2xl border border-[#C8DDE8] bg-[#EAF4FA] p-4">
              <div className="flex items-center justify-between rounded-xl bg-white p-3">
                <div className="flex items-center gap-2 text-sm font-medium text-[#1A1A2E]">
                  <Users aria-hidden="true" className="h-4 w-4 text-[#2E6F8F]" />
              ...
              <div className="flex items-center gap-2 rounded-xl bg-[#2E6F8F]/10 p-3 text-sm font-medium text-[#2E6F8F]">
